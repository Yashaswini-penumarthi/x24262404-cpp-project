...
ALLOWED_HOSTS = ['myeb-app.us-east-1.elasticbeanstalk.com/','*']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'x24262404-rds-postgres',
        'USER': 'postgres',
        'PASSWORD': 'x24262404-rds-postgres',
        'HOST': 'x24262404-rds-postgres.c1fcvjuyby89.us-east-1.rds.amazonaws.com',  # e.g., 'localhost' or remote host
